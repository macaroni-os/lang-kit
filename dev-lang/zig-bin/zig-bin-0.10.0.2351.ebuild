...
SRC_URI="
	arm64? ( https://ziglang.org/builds/zig-linux-aarch64-0.10.0-dev.2351+b64a1d5ab.tar.xz )
	amd64? ( https://ziglang.org/builds/zig-linux-x86_64-0.10.0-dev.2351+b64a1d5ab.tar.xz )"
