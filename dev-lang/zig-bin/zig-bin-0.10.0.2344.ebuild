...
SRC_URI="
	amd64? ( https://ziglang.org/builds/zig-linux-x86_64-0.10.0-dev.2344+1f5b0c115.tar.xz )
	arm64? ( https://ziglang.org/builds/zig-linux-aarch64-0.10.0-dev.2344+1f5b0c115.tar.xz )"
