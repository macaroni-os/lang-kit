...
SRC_URI="
	amd64? ( https://ziglang.org/builds/zig-linux-x86_64-0.10.0-dev.1224+3b6e8fa59.tar.xz )
	arm64? ( https://ziglang.org/builds/zig-linux-aarch64-0.10.0-dev.1224+3b6e8fa59.tar.xz )"
