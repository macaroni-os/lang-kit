...
SRC_URI="
	arm64? ( https://ziglang.org/builds/zig-linux-aarch64-0.10.0-dev.2340+1a92264b3.tar.xz )
	amd64? ( https://ziglang.org/builds/zig-linux-x86_64-0.10.0-dev.2340+1a92264b3.tar.xz )"
