...
SRC_URI="
	amd64? ( https://ziglang.org/builds/zig-linux-x86_64-0.10.0-dev.2978+803376708.tar.xz )
	arm64? ( https://ziglang.org/builds/zig-linux-aarch64-0.10.0-dev.2978+803376708.tar.xz )"
